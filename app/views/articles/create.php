<?php $title = 'Buat Artikel'; require __DIR__ . '/../layouts/header.php'; ?>

<div class="row justify-content-center">
    <div class="col-md-10">
        <div class="card shadow-none">
            <div class="card-header" style="background-color: var(--primary); color: var(--on-primary);">
                <h5 class="mb-0"><i class="fas fa-plus-circle"></i> Buat Artikel Baru</h5>
            </div>
            <div class="card-body">
                <form action="/articles/create" method="POST" enctype="multipart/form-data" id="articleForm">
                    <div class="mb-3">
                        <label class="form-label">Judul Artikel <span style="color: var(--negative);">*</span></label>
                        <input type="text" name="title" id="title" class="form-control <?= error('title') ? 'is-invalid' : '' ?>" value="<?= htmlspecialchars(old('title')) ?>" placeholder="Masukkan judul artikel">
                    ...
                    <div class="mb-3">
                        ...
                        <div id="editor" style="height: 400px;"><?= htmlspecialchars(old('content')) ?></div>
                        <textarea name="content" id="content" hidden><?= htmlspecialchars(old('content')) ?></textarea>
